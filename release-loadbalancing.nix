  ...
  jobs = rec {
    tarball =
      ...
      disnixos.sourceTarball {
        name = "disnix-composition-loadbalancing-tarball";
    ...
    doc =
      ...
      releaseTools.nixBuild {
        name = "disnix-composition-loadbalancing--doc";
        version = builtins.readFile ./version;
        src = tarball;
    ...
    build =
      ...
      disnixos.buildManifest {
        name = "disnix-composition-loadbalancing";
        version = builtins.readFile ./version;
        inherit tarball;
    ...
    tests =
      ...
      in
      disnixos.disnixTest {
        name = "disnix-composition-loadbalancing-tests";
        tarball = tarball {};
